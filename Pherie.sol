...
contract Pherie is Context, IERC20, Ownable {
    ...
    string private _name = "Pherie";
    string private _symbol = "PHERIE";
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
        ...
        _tOwned[communityAddress] = _tOwned[communityAddress].add(calculateCommunityFeeFromMixedFee(tFee));
        _rOwned[communityAddress] = _rOwned[communityAddress].add(calculateCommunityFeeFromMixedFee(rFee));
    ...
    function setCommunityAddres(address account) public onlyOwner {
    ...
    function _reflectFee(uint256 rFee, uint256 tFee) private {
        tFee = tFee.sub(calculateCommunityFeeFromMixedFee(tFee));
        rFee = rFee.sub(calculateCommunityFeeFromMixedFee(rFee));
    ...
    function calculateCommunityFeeFromMixedFee(uint256 _amount) private view returns (uint256) {
        uint256 mixedPercentage = _communityFee + _taxFee;
